...
return array(
    ...
    'properties' => array(
        'creator'        => 'Tacit Inovations',
        'lastModifiedBy' => 'Tacit Inovations',
        'title'          => 'Tacit Inovations',
        'description'    => 'Tacit Inovations spreadsheet export',
        'subject'        => 'Tacit Inovations Spreadsheet export',
        'keywords'       => 'Tacit Inovations',
        'category'       => 'Excel',
        'manager'        => 'Tacit Inovations',
        'company'        => 'Tacit Inovations',
    ),
