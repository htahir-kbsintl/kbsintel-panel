...
<head>
   ...
   <!-- <script src="{{asset("packages/serverfireteam/panel/js/jquery-1.11.0.js")}}"></script>-->
    ...
    <link href="{{asset("custom_assets/css/jquery.comiseo.daterangepicker.css")}}" rel="stylesheet">
...
<body class="@yield('bodyClass')">
    ...
    <script src="{{asset("custom_assets/js/jquery.comiseo.daterangepicker.js")}}"></script>
    <script src="http://cdnjs.cloudflare.com/ajax/libs/moment.js/2.8.3/moment.min.js"></script>
     <script src="{{asset("custom_assets/js/functions.js")}}"></script>
    {!! Rapyd::scripts() !!} 
